...
/*	ret = zixi_configure_pdl(zixi_handle, 128000000, NULL, NULL);
	...
	*/
	...
	zixi_configure_error_correction(zixi_handle, latency, ZIXI_LATENCY_STATIC, fec?ZIXI_FEC_ON:ZIXI_FEC_OFF, fec_overhead, fec_block_ms, fec_content_aware, false, 0, false);
