...
public class ClipCreatorPluginIntegrationTest {
	...
	public void testPeriodicMp4CreationThroughAppSettings() throws Exception {
		...
		boolean stopped = callStopPeriodicRecording();
		assertTrue(stopped);
		...
		Result callDeleteMp4NotInDB = callDeleteMp4NotInDB();
		
		//it should not delete any file because all files are in the database
